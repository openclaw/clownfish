...
- gitcrawl snapshot updated: 2026-06-14T16:20:27Z (ignore for target_updated_at; use hydrated preflight)
...
- gitcrawl snapshot updated: 2026-06-14T16:20:36Z (ignore for target_updated_at; use hydrated preflight)
...
- gitcrawl snapshot updated: 2026-06-14T16:20:39Z (ignore for target_updated_at; use hydrated preflight)
...
- gitcrawl snapshot updated: 2026-06-14T16:22:54Z (ignore for target_updated_at; use hydrated preflight)
...
- gitcrawl snapshot updated: 2026-06-14T16:23:21Z (ignore for target_updated_at; use hydrated preflight)
...
- gitcrawl snapshot updated: 2026-06-14T16:25:07Z (ignore for target_updated_at; use hydrated preflight)
...
- body excerpt: ## Summary - remove the `@anthropic-ai/vertex-sdk` runtime dependency from the shipped OpenClaw package - replace it with a small local Anthropic Vertex client built on the existing `@anthropic-ai/sdk` and `google-auth-library.x` - update the lockfile so
