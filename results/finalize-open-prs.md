...
Generated: 2026-04-28T18:23:59.336Z
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [#73724](https://github.com/openclaw/openclaw/pull/73724) | fix(cli): avoid false local gateway unreachable on probe timeout | ghcrawl-156625-autonomous-smoke | MERGEABLE | UNSTABLE | CANCELLED:3 SKIPPED:10 SUCCESS:27 IN_PROGRESS:25; blockers:25 | security_hold, needs_merge_state:UNSTABLE, needs_checks:CI / build-artifacts:IN_PROGRESS; CI / checks-fast-bundled:IN_PROGRESS; CI / checks-fast-contracts-plugins:IN_PROGRESS, needs_merge_preflight | route to central security triage |
...
| [#73725](https://github.com/openclaw/openclaw/pull/73725) | fix(webchat): create dashboard sessions from New Chat | ghcrawl-156619-autonomous-smoke | MERGEABLE | UNSTABLE | CANCELLED:1 SKIPPED:10 SUCCESS:42 IN_PROGRESS:12; blockers:12 | needs_merge_state:UNSTABLE, needs_checks:CI / build-artifacts:IN_PROGRESS; CI / checks-fast-bundled:IN_PROGRESS; CI / checks-fast-contracts-plugins:IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
