...
Last dashboard update: Jun 15, 2026, 01:41 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 427 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 427 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 232 | 54.3% |
| Needs-human clusters | 53 | 12.4% |
| Latest successful clusters | 418 | 97.9% |
...
| Distinct PRs touched | 1283 | 100% |
| Open PRs tracked | 119 | 9.3% |
