...
Last dashboard update: Apr 27, 2026, 05:33 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 117 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 117 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 61 | 52.1% |
| Needs-human clusters | 32 | 27.4% |
| Latest successful clusters | 115 | 98.3% |
| Latest failed clusters | 2 | 1.7% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 242 | audit |
...
| Distinct PRs touched | 525 | 100% |
| Open PRs tracked | 296 | 56.4% |
| Closed unmerged PRs tracked | 194 | 37.0% |
