...
Last dashboard update: Jun 15, 2026, 02:22 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 724 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 724 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 504 | 69.6% |
| Needs-human clusters | 78 | 10.8% |
| Latest successful clusters | 715 | 98.8% |
| Latest failed clusters | 3 | 0.4% |
| Latest cancelled clusters | 1 | 0.1% |
| Run attempts archived | 1057 | audit |
| Fix action attempts | 254 | audit |
| Fix actions executed | 1 | 0.4% |
| Fix actions failed | 61 | 24.0% |
| Fix actions blocked | 80 | 31.5% |
| Latest clusters with fix failures | 71 | 9.8% |
| Distinct PRs touched | 1760 | 100% |
| Open PRs tracked | 456 | 25.9% |
| Closed unmerged PRs tracked | 1045 | 59.4% |
...
| --- | --- | --- | --- | --- | --- |
| [gitcrawl-868-plan-wave-20260615-b](results/openclaw/gitcrawl-868-plan-wave-20260615-b.md) | needs human | jobs/openclaw/inbox/gitcrawl-868-plan-wave-20260615-b.md | #87986 has a failing Real behavior proof check and the job requires human handling for failing_checks before any merge/fixed-by-candidate... | [report](results/openclaw/gitcrawl-868-plan-wave-20260615-b.md) | [27519089403](https://github.com/openclaw/clownfish/actions/runs/27519089403) |
| [gitcrawl-852-plan-wave-20260615-b](results/openclaw/gitcrawl-852-plan-wave-20260615-b.md) | needs human | jobs/openclaw/inbox/gitcrawl-852-plan-wave-20260615-b.md | #87986 has a failing Real behavior proof check; maintainer judgment is required before any merge path outside this plan-only job. | [report](results/openclaw/gitcrawl-852-plan-wave-20260615-b.md) | [27519083043](https://github.com/openclaw/clownfish/actions/runs/27519083043) |
...
| [gitcrawl-709-plan-wave-20260615-a](results/openclaw/gitcrawl-709-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-709-plan-wave-20260615-a.md | #89602 requires maintainer/proof follow-up before any merge or fixed-by-candidate closeout because Real behavior proof and Run agentic na... | [report](results/openclaw/gitcrawl-709-plan-wave-20260615-a.md) | [27518985436](https://github.com/openclaw/clownfish/actions/runs/27518985436) |
...
| [gitcrawl-685-plan-wave-20260615-a](results/openclaw/gitcrawl-685-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-685-plan-wave-20260615-a.md | #90049 still needs maintainer/product judgment on heartbeat-specific fallback or retry semantics after the diagnostic split, because the ... | [report](results/openclaw/gitcrawl-685-plan-wave-20260615-a.md) | [27518974372](https://github.com/openclaw/clownfish/actions/runs/27518974372) |
| [gitcrawl-665-plan-wave-20260615-a](results/openclaw/gitcrawl-665-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-665-plan-wave-20260615-a.md | Maintainers need to decide the product contract for #73432: keep lexical search mode embedding-free and document/use the query/vsearch wo... | [report](results/openclaw/gitcrawl-665-plan-wave-20260615-a.md) | [27518916454](https://github.com/openclaw/clownfish/actions/runs/27518916454) |
| [gitcrawl-655-plan-wave-20260615-a](results/openclaw/gitcrawl-655-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-655-plan-wave-20260615-a.md | Maintainer should choose whether #90249 remains canonical, #90406 becomes the canonical replacement, or both should be combined/split bef... | [report](results/openclaw/gitcrawl-655-plan-wave-20260615-a.md) | [27518912559](https://github.com/openclaw/clownfish/actions/runs/27518912559) |
| [gitcrawl-624-plan-wave-20260615-a](results/openclaw/gitcrawl-624-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-624-plan-wave-20260615-a.md | Maintainer/product decision remains for #90789/#90799: whether the exact Claude CLI synthetic placeholders should route through existing ... | [report](results/openclaw/gitcrawl-624-plan-wave-20260615-a.md) | [27518898305](https://github.com/openclaw/clownfish/actions/runs/27518898305) |
| [gitcrawl-605-plan-wave-20260615-a](results/openclaw/gitcrawl-605-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-605-plan-wave-20260615-a.md | Maintainer review is still required to decide whether #91208's pinned session-extension registry lifecycle and cleanup behavior are accep... | [report](results/openclaw/gitcrawl-605-plan-wave-20260615-a.md) | [27518888197](https://github.com/openclaw/clownfish/actions/runs/27518888197) |
| [gitcrawl-593-plan-wave-20260615-a](results/openclaw/gitcrawl-593-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-593-plan-wave-20260615-a.md | Choose the live canonical path for the gateway.nodes.invokeTimeoutMs feature: keep repairing #68857, switch canonical ownership to #92714... | [report](results/openclaw/gitcrawl-593-plan-wave-20260615-a.md) | [27518886225](https://github.com/openclaw/clownfish/actions/runs/27518886225) |
| [gitcrawl-565-plan-wave-20260615-a](results/openclaw/gitcrawl-565-plan-wave-20260615-a.md) | needs human | jobs/openclaw/inbox/gitcrawl-565-plan-wave-20260615-a.md | #91476 needs maintainer decision on the compatibility-sensitive public config/Plugin SDK surface before any merge path; merge/fix actions... | [report](results/openclaw/gitcrawl-565-plan-wave-20260615-a.md) | [27518876172](https://github.com/openclaw/clownfish/actions/runs/27518876172) |
