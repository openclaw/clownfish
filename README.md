...
Last dashboard update: Apr 27, 2026, 05:28 UTC

<!-- projectclownfish-dashboard:start -->
State: Fix execution needs repair

Scope: 108 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 108 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 56 | 51.9% |
| Needs-human clusters | 31 | 28.7% |
| Latest successful clusters | 108 | 100.0% |
...
| Open PRs tracked | 288 | 57.8% |
| Closed unmerged PRs tracked | 176 | 35.3% |
