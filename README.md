...
Scope: 329 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 329 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 154 | 46.8% |
| Needs-human clusters | 49 | 14.9% |
| Latest successful clusters | 301 | 91.5% |
| Latest failed clusters | 4 | 1.2% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 582 | audit |
...
| Distinct PRs touched | 1030 | 100% |
| Open PRs tracked | 389 | 37.8% |
| Closed unmerged PRs tracked | 523 | 50.8% |
