...
Last dashboard update: Apr 29, 2026, 05:12 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 234 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 234 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 99 | 42.3% |
| Needs-human clusters | 40 | 17.1% |
| Latest successful clusters | 224 | 95.7% |
| Latest failed clusters | 3 | 1.3% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 472 | audit |
| Fix action attempts | 160 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 35 | 21.9% |
| Fix actions blocked | 48 | 30.0% |
| Latest clusters with fix failures | 43 | 18.4% |
