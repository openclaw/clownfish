...
Last dashboard update: Apr 30, 2026, 01:51 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 353 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 353 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 176 | 49.9% |
| Needs-human clusters | 51 | 14.4% |
| Latest successful clusters | 325 | 92.1% |
| Latest failed clusters | 4 | 1.1% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 606 | audit |
...
| Distinct PRs touched | 1071 | 100% |
| Open PRs tracked | 424 | 39.6% |
