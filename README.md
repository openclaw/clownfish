...
Last dashboard update: Apr 30, 2026, 01:52 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 354 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 354 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 177 | 50.0% |
| Needs-human clusters | 51 | 14.4% |
| Latest successful clusters | 326 | 92.1% |
| Latest failed clusters | 4 | 1.1% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 607 | audit |
| Fix action attempts | 164 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 35 | 21.3% |
| Fix actions blocked | 50 | 30.5% |
| Latest clusters with fix failures | 44 | 12.4% |
| Distinct PRs touched | 1073 | 100% |
| Open PRs tracked | 425 | 39.6% |
| Closed unmerged PRs tracked | 529 | 49.3% |
