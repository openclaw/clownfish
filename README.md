...
Last dashboard update: Apr 29, 2026, 21:53 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 317 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 317 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 145 | 45.7% |
| Needs-human clusters | 46 | 14.5% |
| Latest successful clusters | 289 | 91.2% |
| Latest failed clusters | 4 | 1.3% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 570 | audit |
...
| Distinct PRs touched | 993 | 100% |
| Open PRs tracked | 362 | 36.5% |
| Closed unmerged PRs tracked | 517 | 52.1% |
