...
Last dashboard update: Jun 15, 2026, 00:19 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 412 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 412 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 219 | 53.2% |
| Needs-human clusters | 51 | 12.4% |
| Latest successful clusters | 403 | 97.8% |
| Latest failed clusters | 3 | 0.7% |
| Latest cancelled clusters | 1 | 0.2% |
| Run attempts archived | 738 | audit |
...
| Distinct PRs touched | 1247 | 100% |
| Open PRs tracked | 98 | 7.9% |
| Closed unmerged PRs tracked | 956 | 76.7% |
