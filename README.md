...
Scope: 343 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 343 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 166 | 48.4% |
| Needs-human clusters | 51 | 14.9% |
| Latest successful clusters | 315 | 91.8% |
| Latest failed clusters | 4 | 1.2% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 596 | audit |
...
| Distinct PRs touched | 1059 | 100% |
| Open PRs tracked | 413 | 39.0% |
| Closed unmerged PRs tracked | 527 | 49.8% |
